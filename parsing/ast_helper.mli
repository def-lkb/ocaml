...
module Exp:
  sig
    ...
    val apply: ?loc:loc -> ?attrs:attrs -> expression -> (apply_flag * expression) list -> expression
...
module Sig:
  sig
    ...
    val open_: ?loc:loc -> ?attrs:attrs -> open_flag -> lid -> signature_item
...
module Str:
  sig
    ...
    val open_: ?loc:loc -> ?attrs:attrs -> open_flag -> lid -> structure_item
