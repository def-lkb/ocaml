...
module Make(O : OBJ)(EVP : EVALPATH with type valu = O.t) = struct
    ...
    let abstract_type =
      Ctype.newty
        (Tconstr (Pident (Ident.create_dummy "abstract"), [], ref Mnil))
